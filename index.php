...
<body>
    ...
    <main>
        ...
        <button onclick="location.href = './webroot/ejercicios/pr1-2-3.html'" class="active"><p>Ejercicio 1-2-3</p></button>
        <button onclick="location.href = './webroot/ejercicios/pr2-1.html'" class="active"><p>Ejercicio 2-1</p></button>
        <button onclick="location.href = './webroot/ejercicios/pr2-3.html'" class="active"><p>Ejercicio 2-3</p></button>
